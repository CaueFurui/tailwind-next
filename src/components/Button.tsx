...
const button = tv({
  base: [
    ...
    'focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-violet-2',
    'active:opacity-80',
  ],
  ...
  variants: {
    variant: {
      ...
      ghost:
        'rounded-md px-2 hover:bg-white/5 shadow-none text-zinc-500 dark:text-zinc-400 dark:hover:bg-zinc-800',
      outline:
